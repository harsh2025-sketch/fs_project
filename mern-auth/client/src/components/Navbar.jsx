...
const Navbar = () => {
    ...
    p-4 sm:p-6 sm:px-24 absolute top-0'>
                ...
                <div className='w-8 h-8 flex justify-center items-center rounded-full bg-black text-white relative group'>
                    ...
                    <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-10'>
                        <ul className='list-none m-0 p-2 bg-gray-100 text-sm'>
                            <li onClick={() => navigate('/dashboard')} className='py-1 px-2 hover:bg-gray-200 cursor-pointer'>Dashboard</li>
            ...
            rounded-full px-2 py-2 text-gray-800 hover:bg-gray-100 transitn-all'>
                    Login <img src={assets.arrow_icon} alt=''></img></button>
            }
        </div>
    )
}
