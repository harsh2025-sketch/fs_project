...
import { EMAIL_VERIFY_TEMPLATE, PASSWORD_RESET_TEMPLATE, WELCOME_EMAIL_TEMPLATE, LOGIN_NOTIFICATION_TEMPLATE } from '../config/emailTemplates.js';
...
export const login = async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            from: process.env.SENDER_EMAIL,
            to: email,
            subject: 'Login Notification - Agrovaan 🔐',
            html: LOGIN_NOTIFICATION_TEMPLATE
